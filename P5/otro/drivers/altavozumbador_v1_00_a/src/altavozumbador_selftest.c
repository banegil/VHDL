...
XStatus ALTAVOZUMBADOR_SelfTest(void * baseaddr_p)
{
  ...
  ALTAVOZUMBADOR_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = ALTAVOZUMBADOR_mReadSlaveReg0(baseaddr, 0);
  ...
  ALTAVOZUMBADOR_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = ALTAVOZUMBADOR_mReadSlaveReg1(baseaddr, 0);
