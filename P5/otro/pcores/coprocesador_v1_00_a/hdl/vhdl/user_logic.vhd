...
-- Date:              Fri Oct 18 15:33:26 2013 (by Create and Import Peripheral Wizard)
...
signal reloj12,reloj,rst,Reloj_1Hz,Reloj_38KHz: std_logic;
...
-- Divisor de frecuencias que obtiene en Reloj_38KHz una señal de reloj de 38 KHz (frecuencia portadora)
 ...
 VARIABLE cuenta1: std_logic_vector (27 DOWNTO 0);
 BEGIN
 ...
 divisor_1Hz:
 PROCESS ( Bus2IP_Reset, Bus2IP_Clk )
 VARIABLE cuenta2: std_logic_vector (27 DOWNTO 0);
 BEGIN
 IF (Bus2IP_Reset='1') THEN
 cuenta2:= (OTHERS=>'0');
 ELSIF (Bus2IP_Clk'EVENT AND Bus2IP_Clk='1') THEN
 ...
 code_infrared <= Reloj_38KHz AND Reloj_1Hz AND R(3); --R(3) se multiplexa con la signal activeER, porque comparten el pin J14
