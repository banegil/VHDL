...
-- Date:              Wed Feb 17 14:29:14 2021 (by Create and Import Peripheral Wizard)
...
begin
  ...
  -----------------------------------
  -- GENERADOR DEL SONIDO O ZUMBIDO--
  -----------------------------------
  altavoz_p: PROCESS(slv_reg1, Bus2IP_Clk, Bus2IP_Reset)
  BEGIN
     --Si escribo un 0 en el registro1 sonido
	  IF(slv_reg1(31) = '0') THEN
	  z <= '1'; --apago zumbador por si acaso
		 IF(Bus2IP_Reset='1')THEN
			q <= '0';
			cs <= (OTHERS=>'0');
		 ELSIF(Bus2IP_Clk'event and Bus2IP_Clk='1') THEN	
			 ...
			 END IF;
		 END IF;
		--este else es el zumbido
      --Si escribo un 1 en el registro1 zumbido
	   ELSE
	   	q <= '1'; --apago altavoz por si acaso
		z <= '0';
           END IF;
   END PROCESS;
	
  multiplexor: PROCESS(slv_reg1, Bus2IP_Clk)
  BEGIN
	IF(Bus2IP_Clk'event and Bus2IP_Clk='1') THEN
		--Si escribo un 0 en el registro1 sonido
		IF(slv_reg1(31) = '0') THEN
