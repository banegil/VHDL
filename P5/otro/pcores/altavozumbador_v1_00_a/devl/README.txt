...
Peripheral Summary:
  ...
  logical library name                       : altavozumbador_v1_00_a
  top name                                   : altavozumbador
  version                                    : 1.00.a
  type                                       : PLB (v4.6) slave
...
- XPS interface file(s)
  ...
  data/altavozumbador_v2_1_0.mpd
  ...
  data/altavozumbador_v2_1_0.pao
...
- ISE project file(s)
  ...
  devl/projnav/altavozumbador.ise
...
- XST synthesis file(s)
  ...
  devl/synthesis/altavozumbador_xst.prj
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/altavozumbador_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/altavozumbador_v2_1_0.tcl
