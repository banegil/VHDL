...
entity user_logic is
  ...
  (
    ...
    -- ADD USER PORTS ABOVE THIS LINE ------------------
		...
		botonIz_uLogic 				  	  : in std_Logic; 
		botonDer_uLogic 				  : in std_Logic; 
...
component counter2 IS
	...
	signal nFilas: std_logic_vector(3 downto 0);
	signal nColumnas: std_logic_vector(3 downto 0);
...
timeOut <= "11"; -- 12,5 MHz
	...
	nFilas(0) <= WFIFO2IP_Data(19);
	nFilas(1) <= WFIFO2IP_Data(17);
	nFilas(2) <= WFIFO2IP_Data(17);
	nFilas(3) <= WFIFO2IP_Data(16);
	
	nColumnas(0) <= WFIFO2IP_Data(15);
	nColumnas(1) <= WFIFO2IP_Data(14);
	nColumnas(2) <= WFIFO2IP_Data(13);
	nColumnas(3) <= WFIFO2IP_Data(12);
