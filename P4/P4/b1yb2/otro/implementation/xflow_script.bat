...
@REM #
ngdbuild -p xc3s1000ft256-5 -nt timestamp -bm system1.bmm "C:/Users/baneg/Desktop/SE/practicas/P4/otro/implementation/system1.ngc" -uc system1.ucf system1.ngd 
