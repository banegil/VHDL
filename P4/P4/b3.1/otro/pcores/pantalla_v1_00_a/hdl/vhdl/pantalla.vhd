------------------------------------------------------------------------------
-- pantalla.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
--
------------------------------------------------------------------------------
-- Filename:          pantalla.vhd
-- Version:           1.00.a
-- Description:       Top level design, instantiates library components and user logic.
-- Date:              Thu Nov 26 19:11:14 2020 (by Create and Import Peripheral Wizard)
...
use pantalla_v1_00_a.user_logic;
...
entity pantalla is
  ...
  (
	...
	p_rgb						   : out std_logic_vector(8 downto 0);	-- red,green,blue colors
	botonIz						   : in std_Logic; 
	botonDer					   : in std_Logic; 
	s_filas						   : in std_logic_vector(3 downto 0);
	s_columnas					   : in std_logic_vector(3 downto 0);
...
architecture IMP of pantalla is
...
begin
  ...
  ------------------------------------------
  USER_LOGIC_I : entity pantalla_v1_00_a.user_logic
    generic map
    (
    ...
    (
	  ...
	  vsyncb 					 	 => vsync,
	  rgb 					 		 => p_rgb,
	  botonIz_uLogic 				 => botonIz,
	  botonDer_uLogic 			     => botonDer,
	  filas						 	 => s_filas,
	  columnas						 => s_columnas,
