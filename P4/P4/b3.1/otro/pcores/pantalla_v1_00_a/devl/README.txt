...
Peripheral Summary:
  ...
  XPS project / EDK repository               : C:\Users\baneg\Desktop\SE\practicas\P2\otro
...
Address Block for User Logic and IPIF Predefined Services
  ...
  write fifo register space                  : C_BASEADDR + 0x00000100
  (WrFIFO Reset/MIR, WrFIFO Status)          : C_BASEADDR + 0x000001FF
  write fifo data space                      : C_BASEADDR + 0x00000200
...
- XST synthesis file(s)
  ...
  devl/synthesis/pantalla_xst.prj
...
plbv46_slave_single_v1_01_a
	C:\Users\baneg\Desktop\SE\practicas\P2\otro\C:\Xilinx\14.1\ISE_DS\EDK\hw\XilinxProcessorIPLib\pcores\plbv46_slave_single_v1_01_a\doc\plbv46_slave_single.pdf

wrpfifo_v5_01_a
	C:\Users\baneg\Desktop\SE\practicas\P2\otro\C:\Xilinx\14.1\ISE_DS\EDK\hw\XilinxProcessorIPLib\pcores\wrpfifo_v5_01_a\doc\wrpfifo.pdf
...
IP2WFIFO_RdReq
    Indicates that the IP is attempting to read data from the WrFIFO. The 
    transaction is not completed until the WrFIFO responds with an active high 
    assertion on the WFIFO2IP_RdAck signal and a corresponding rising edge of 
...
WFIFO2IP_RdAck
    This signal asserts in response to a User IP read request of the WrFIFO. 
    Data on the WFIFO2IP_Data bus is valid for reading when this signal is 
    asserted in conjunction with the rising edge of the Bus2IP_Clk. 

WFIFO2IP_AlmostEmpty
    Indicates that the WrFIFO can provide only one more data read. 

WFIFO2IP_Empty
    Indicates that the WrFIFO is empty and cannot provide data. The 
    WFIFO2IP_RdAck signal assertion will be suppressed until the FIFO is no 
    longer empty. 
