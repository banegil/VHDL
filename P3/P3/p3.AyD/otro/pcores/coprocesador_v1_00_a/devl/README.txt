...
Peripheral Summary:
  ...
  XPS project / EDK repository               : C:\hlocal\otro
...
- XST synthesis file(s)
  ...
  devl/synthesis/coprocesador_xst.prj
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/coprocesador_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/coprocesador_v2_1_0.tcl
...
plbv46_slave_single_v1_01_a
	C:\hlocal\otro\C:\Xilinx\14.1\ISE_DS\EDK\hw\XilinxProcessorIPLib\pcores\plbv46_slave_single_v1_01_a\doc\plbv46_slave_single.pdf
